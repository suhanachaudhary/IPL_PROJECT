...
//       method: 'GET',
//       headers: {
//         'x-rapidapi-key': 'b03fe986aamsh495a1d58667d950p1ab04ajsn2ab907a2738e',
...
//   <div className=''>
//     <h2>Match info....</h2>
//     <div className="text-2xl text-center m-5"></div>
//           {data.length <= 0 ? (
//               <h1>Loding....</h1>
//           ) : (
//               <InPageNavigation>
//                       {/* {
//                           fixedData.matchInfo.state.map((data,i) => (
//                               <div key={i} className="text-xl m-5">
//                                   <h3 >{data}</h3>
//                               </div>
//                           ))
//                       } */}
//                       <h3 className='text-center mt-4'>Comint soon</h3>
